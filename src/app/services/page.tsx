    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto max-w-[1200px] px-[15px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {services.map((svc) => {
              ...
              return (
                <div key={svc.id} className="bg-[#f9f9f9] rounded-[8px] overflow-hidden hover:-translate-y-1 transition-transform duration-300 shadow-[0_5px_20px_rgba(0,0,0,0.04)]">
                  {/* Service Image */}
                  <div className="relative w-full h-[200px] overflow-hidden">
                    ...
                    <div className="absolute bottom-4 right-4 w-12 h-12 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-lg">
                      <Icon size={22} className="text-[#8eb93e]" />
                    </div>
                  </div>
                  <div className="p-8">
      ...
      <section className="relative py-[80px] bg-[#1a1a1a] overflow-hidden">
        ...
        <div className="container mx-auto max-w-[1200px] px-[15px] relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-[8px] text-center">
              <div className="relative w-full h-[200px] mb-6 overflow-hidden rounded">
                <Image src="https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?w=600&h=400&fit=crop&q=80" alt="Cab Services - Fleet of vehicles" fill className="object-cover" />
              </div>
            ...
            <div className="bg-white p-8 rounded-[8px] text-center">
              <div className="relative w-full h-[200px] mb-6 overflow-hidden rounded">
                <Image src="https://images.unsplash.com/photo-1566073771259-6a8506099945?w=600&h=400&fit=crop&q=80" alt="Hotel Booking - Premium resort" fill className="object-cover" />
              </div>
